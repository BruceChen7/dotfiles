...
function! vimmake#keymap()
	...
	" noremap <silent><F4> :VimBuild auto<cr>
	" noremap <silent><F5> :VimExecute auto<cr>
	" noremap <silent><F7> :VimBuild gcc<cr>
	" noremap <silent><F9> :call vimmake#toggle_quickfix(6)<cr>
	...
	inoremap <silent><F9> <ESC>:call vimmake#toggle_quickfix(6)<cr>

	noremap <silent><F8> :cp<cr>
	noremap <silent><F7> :cn<cr>
	inoremap <silent><F8> <ESC>:cp<cr>
